...
const metrics = [
  ...
  { label: "Average AI Score", value: "76/100" },
  { label: "Total Projects", value: "38" },
];

const submissions = [
  { date: "Feb 19, 2026", project: "auth-service", language: "Java", score: 91 },
  { date: "Feb 18, 2026", project: "payment-gateway", language: "Python", score: 67 },
  { date: "Feb 17, 2026", project: "search-engine", language: "C++", score: 82 },
  { date: "Feb 16, 2026", project: "chat-api", language: "JavaScript", score: 54 },
  { date: "Feb 15, 2026", project: "ml-pipeline", language: "Python", score: 73 },
  { date: "Feb 14, 2026", project: "data-sync", language: "Java", score: 88 },
];
      ...
      <div className="w-full max-w-5xl flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-500">
            AI-powered code review and optimization at a glance.
          </p>
        </div>
